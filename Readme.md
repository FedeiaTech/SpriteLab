...
* **✂️ Recorte de Tiempo Preciso:** Slider de rango visual (RangeSlider) para seleccionar el inicio y fin exacto de la animación (Loop), con precisión de milisegundos.
